...
/**
 * La clase PrimerBus representa un tipo específico de bus.
 */
public class PrimerBus extends Bus {
    ...
    /**
     * Constructor de la clase PrimerBus.
     *
     ...
     */
    public PrimerBus(Recorrido origen, Recorrido destino, String horario) {
        this.origen = origen;
        this.destino = destino;
        this.horario = horario;
        precioAsientoSemiCama = 3500;
        precioAsientoSalonCama = 4500;
        precioAsientoSalonVip = 6000;
    }
